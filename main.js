        ...
        return {
            ...
            getTemplateSource: function (s) {
                ...
                return plugin.initLoaded
                    ? Promise.resolve((_b = (_a = plugin.eta.loader.templateCache.get(s)) === null || _a === void 0 ? void 0 : _a.source) !== null && _b !== void 0 ? _b : null)
                    : (() => {
                        return new Promise((resolve, reject) => {
                            let x = plugin.app.workspace.on('skribi:template-init-complete', () => {
                                var _a, _b;
                                plugin.app.workspace.offref(x);
                                resolve((_b = (_a = plugin.eta.loader.templateCache.get(s)) === null || _a === void 0 ? void 0 : _a.source) !== null && _b !== void 0 ? _b : null);
                            });
